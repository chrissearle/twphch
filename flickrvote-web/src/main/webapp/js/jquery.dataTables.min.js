...
(function($) {
    ...
    _oExt.aoFeatures = [];
    _oExt.ofnSearch = {};
    _oExt.oPagination = {two_button:{fnInit:function(oSettings, fnCallbackDraw) {
    ...
    $.fn.dataTable = function(oInit) {
        ...
        function _fnAddData(oSettings, aData) {
            ...
            oSettings.aoData.push({_iId:oSettings.iNextId++,_aData:aData.slice(),nTr:document.createElement("tr"),_anHidden:[]});
            var nTd;
            ...
            if (oSettings.oFeatures.bSort) {
                for (i = 0; i < oSettings.aoColumns.length; i++) {
                    ...
                    $(oSettings.aoColumns[i].nTh).click(function(e) {
                        var iDataIndex;
                        for (var i = 0; i < oSettings.aoColumns.length;
                             i++) {
                        ...
                        var fnInnerSorting = function() {
                            if (e.shiftKey) {
                                var bFound = false;
                                for (var i = 0; i < oSettings.aaSorting.length;
                                     i++) {
